...
exports.UserClan = void 0;
var _react = require("react");
var _io = require("react-icons/io5");
var _reactModal = _interopRequireDefault(require("react-modal"));
require("../styles/UserClanstyles.css");
var _Member = require("../../Members/app/Member");
...
var UserClan = exports.UserClan = function UserClan() {
  ...
  (0, _react.useEffect)(function () {
    var getUserClans = /*#__PURE__*/function () {
    ...
    var getClanInfo = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return _axios.default.request({
                url: "http://localhost:8080/api/clan/".concat(clanId),
                method: 'get',
                headers: {
                  Authorization: "".concat(accessToken)
                }
      ...
      return function getClanInfo(_x) {
        return _ref2.apply(this, arguments);
      };
    }();
    getUserClans().then(function (clanid) {
      if (clanid) {
        getClanInfo(clanid);
      }
    });
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(_Member.Member, {
      id: index,
      fname: item.fname,
      lname: item.lname,
      email: item.email,
