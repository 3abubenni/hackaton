...
require("../styles/InventoryListstyles.css");
var _InventoryItem = require("../../InventoryItem/app/InventoryItem");
...
var Inventory = exports.Inventory = function Inventory() {
  var _useState = (0, _react.useState)({
      children: []
    }),
    _useState2 = _slicedToArray(_useState, 1),
    inventoryList = _useState2[0];
  (0, _react.useEffect)(function () {
    var getUsersInventoryItem = /*#__PURE__*/function () {
      ...
      return function getUsersInventoryItem() {
        return _ref.apply(this, arguments);
      };
    }();
    getUsersInventoryItem();
  });
  var _useState3 = (0, _react.useState)(inventoryList),
    _useState4 = _slicedToArray(_useState3, 2),
    filteredInventory = _useState4[0],
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "inventoryListMainView"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, filteredInventory.children.map(function (item, index) {
    return /*#__PURE__*/React.createElement(_InventoryItem.InventoryItem, {
      key: index,
      id: item.id,
      name: item.name,
