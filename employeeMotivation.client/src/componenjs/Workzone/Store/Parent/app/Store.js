...
var _StoreItem = require("../../StoreItem/app/StoreItem");
...
var Store = exports.Store = function Store() {
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _axios.default.request({
                url: "http://localhost:8080/api/shop/clan/item/".concat(userClanId),
                method: "get",
                headers: {
  ...
  var _useState5 = (0, _react.useState)(storeList),
    _useState6 = _slicedToArray(_useState5, 2),
    filteredStore = _useState6[0],
    setFilteredStore = _useState6[1];
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(_StoreItem.StoreItem, {
      key: index,
      id: item.id,
      name: item.name,
